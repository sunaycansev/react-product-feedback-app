...
function Feedback() {
  return (
    <Link to="/">
      <div className="bg-white flex p-5 rounded-lg transition ease-in duration-300 hover:translate-y-1 shadow-md">
            ...
            <div className="content flex flex-col mx-2">
              ...
              <div className="para">
                <p>
                  ...
                  Tenetur quod beatae aspernatur quos excepturi, dolores neque
                  placeat itaque illo nisi? Perferendis quaerat pariatur minima
                  animi.
                </p>
              </div>
